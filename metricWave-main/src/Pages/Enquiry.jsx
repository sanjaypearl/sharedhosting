            ...
            <div className="container my-4">
                <div className="row">
                    ...
                    <div className="d-flex page_breadcrumbs">
                        ...
                        <Link to="/report-store" className="">Report /</Link>
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-9 col-lg-8">
                                <div className="compost-card text-white mb-4">
                                    <h1 className="fw-bold">{reportData.industry}</h1>
                                ...
                                <div className='_discount_div'>
                                    <SampleRequestForm heading="Inquire Before Buy" type="2" report_id={reportData?.id} />
                                </div>
                            </div>
                            ...
                            <div className="col-xl-3 col-lg-4">
                                <div className="request-form-box mb-4 pt-0">
                                    ...
                                    <form>
                                        ...
                                        <hr />
                                        <Link to="/buy-now" type="submit" className="animated-btn"><i class="fa-solid fa-cart-shopping me-2"></i>BUY NOW <span>&rarr;</span></Link>
                                    </form>
                                </div>
                                <div className='_discount_div mb-4'>
                                    ...
                                    <Link to={`/enquiry/${reportData.report_id}`} className="animated-btn text-center w-100 mt-2 enquiry_btn"><img src="https://cdn-icons-png.flaticon.com/128/942/942802.png" alt="" />Enquiry Before Buy</Link>
